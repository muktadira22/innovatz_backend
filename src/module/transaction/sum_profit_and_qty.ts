...
const SumProfitAndQty = async (req: Express.Request, res: Express.Response) => {
  // Get request params
  // let sort = {
  //   createdAt: -1,
  // };
  ...
  SELECT i.id, i.name, sum(dt.price * dt.qty) as profit, count(dt.qty) as count 
  FROM item i 
...
export default SumProfitAndQty;
